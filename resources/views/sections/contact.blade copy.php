...
<script type="text/javascript">
    document.addEventListener("DOMContentLoaded", function() {
        ...
        // 1. Apni PUBLIC KEY yahan dalo
        emailjs.init("JZYBGM9RwZTFnex70"); 
        ...
        form.addEventListener('submit', function(e) {
            ...
            // 2. Apni SERVICE ID aur TEMPLATE ID yahan dalo
            emailjs.sendForm('service_lvddx18', 'template_ealotji', this)
                .then(function() {
                    // Success
